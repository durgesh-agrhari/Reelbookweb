...
const EarningHistory = () => {
  ...
  // 🟩 Fetch earning data (wrapped in useCallback)
  ...
  // 🟩 Fetch when userData is available
  useEffect(() => {
    fetchData();
  }, [fetchData]);
    ...
    >
      <div style={{ maxWidth: "600px", width: "100%" }}>
        ...
        <div className="summary-box">
          ...
          <p className="coins">
            {monthlyData
              .reduce((acc, i) => acc + i.totalCoins, 0)
              .toFixed(0)}{" "}
            Coins
          </p>
          <p className="rupees">
            ₹{" "}
            {coinToRupee(
              monthlyData.reduce((acc, i) => acc + i.totalCoins, 0)
            )}
          </p>
        </div>
              ...
              return (
                <div className="earning-card" key={i}>
                  <div className="left">
                    ...
                    <p>
                      Total Reels: <strong>{item.reels}</strong>
                    </p>
                    <p>
                      Total Posts: <strong>{item.posts}</strong>
                    </p>
                    <p>
                      Total Stories: <strong>{item.stories}</strong>
                    </p>
                    <p>
                      Views: <strong>{item.views}</strong>
                    </p>
                    <p>
                      Likes: <strong>{item.likes}</strong>
                    </p>
                    <p>
                      Coins Earned:{" "}
        ...
        <div className="note-box">
          <p>
            <strong style={{ color: "black" }}>
              Please withdraw only in mobile...
            </strong>
          </p>
        </div>
