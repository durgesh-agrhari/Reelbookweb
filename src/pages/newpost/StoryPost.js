...
import backendURL, { ADD_STORY, UPLOAD_STORY } from "../../utils/String"; 
...
const StoryPost = () => {
  ...
  const handleUpload = async (e) => {
    ...
    try {
      ...
      const uploadRes = await fetch(backendURL + UPLOAD_STORY, {
        method: "POST",
        body: formData,
      });
      ...
      await axios.post(backendURL + ADD_STORY, addPostObj);
